...
export default function MovieVideo(){
    ...
    return(
        ...
        <div className="video-area">
            <video src={'https://res.cloudinary.com/dsike2jgr/video/upload/v1771335888/Asuran_dosyjf.mp4'} id="roomMovie" autoPlay muted style={chatOpen?{width:'100%'}:{width:'80%'}} ref={video}></video>
